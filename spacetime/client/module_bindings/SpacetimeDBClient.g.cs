...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        ...
        {
            AddTable(Article = new(conn));
            AddTable(Deposit = new(conn));
            AddTable(Package = new(conn));
            AddTable(TransportLog = new(conn));
        }
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override Reducer ToReducer(TransactionUpdate update)
        {
            ...
            {
                "AdvancePackageState" => BSATNHelpers.Decode<Reducer.AdvancePackageState>(encodedArgs),
                "CreateTravelOrder" => BSATNHelpers.Decode<Reducer.CreateTravelOrder>(encodedArgs),
                "Init" => BSATNHelpers.Decode<Reducer.Init>(encodedArgs),
                "UpdateArticleStatus" => BSATNHelpers.Decode<Reducer.UpdateArticleStatus>(encodedArgs),
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.AdvancePackageState args => Reducers.InvokeAdvancePackageState(eventContext, args),
                Reducer.CreateTravelOrder args => Reducers.InvokeCreateTravelOrder(eventContext, args),
                Reducer.Init args => Reducers.InvokeInit(eventContext, args),
                Reducer.UpdateArticleStatus args => Reducers.InvokeUpdateArticleStatus(eventContext, args),
